...
supp_table <- supp_data %>% inner_join(supp_table)

supp_table <- supp_table %>% select(apple_id, PLANTID,ploidy, usda_ploidy, het, release_year, acidity_17_harv, brix_17_harv, brix_acid_17_harv, weight_avg_17_harv,firmness_avg_17_harv, percent_firmness_avg_17, tpc, flowering_jul_16_harv, time_ripen_2017,date_jul_17_harv)

write_csv(supp_table, "data/TableS1.csv")
